...
object InhaGongjeonUniversity {

    private const val BASIC_SEARCH_URL =
        "https://library.inhatc.ac.kr:444/elibrary-front/search/searchList.ink?schClst=all&schDvsn=000&orderByKey=&schTxt="
    private const val BASIC_MORE_VIEW_SEARCH_URL =
        "https://library.inhatc.ac.kr:444/elibrary-front/search/searchList.ink?brcd=&sntnAuthCode=&contentAll=&cttsDvsnCode=&orderByKey=&schClst=all&schDvsn=000&reSch=&ctgrId=&allClstCheck=on" +
                "&clstCheck=ctts&clstCheck=autr&clstCheck=pbcm&clstCheck=intc_cntt&allDvsnCheck=000&dvsnCheck=001&reSchTxt=&pageIndex=1&recordCount=20"
